		...
		<div class="container">
			<div class="row margin-vert-30"
				...
				<div class="col-md-3"
					...
					<h3 class="title">
						<img id="playerPic1" src="player.png" class="play" /><span>即時熱門排行</span>
					</h3>
					<h6 style="margin: 0;">1<img src="left.JPG" style="margin-left:10px;" /></h6>
					...
					<hr>
					<h6 style="margin: 0;">2<img src="left.JPG" style="margin-left:10px;" /></h6>
					<h4 style="margin: 0;">7:00 am - 1:30 pm</h4>
					<p>
						<small>* Lorem ipsum dolor sit amet</small>
					</p>
					<hr>
					<h6 style="margin: 0;">3<img src="left.JPG" style="margin-left:10px;" /></h6>
					<h4 style="margin: 0;">7:00 am - 1:30 pm</h4>
					<p>
						<small>* Lorem ipsum dolor sit amet</small>
					</p>
					<hr>
					<h6 style="margin: 0;">4<img src="left.JPG" style="margin-left:10px;" /></h6>
					<h4 style="margin: 0;">CLOSED</h4>
					<p>
						<small>* Lorem ipsum dolor sit amet</small>
					</p>
					<hr>
					<h6 style="margin: 0;">5<img src="left.JPG" style="margin-left:10px;" /></h6>
					<h4 style="margin: 0;">7:00 am - 1:30 pm</h4>
					<p>
						<small>* Lorem ipsum dolor sit amet</small>
					</p>
				...
				<div class="col-md-3"
					...
					<h3 class="title">
						<img id="playerPic2" src="player.png" class="play" /><span>所有類型排行</span>
					</h3>
					<h6 style="margin: 0;">1<img src="left.JPG" style="margin-left:10px;" /></h6>
					<h4 style="margin: 0;">7:00 am - 1:30 pm</h4>
					<p>
				...
				<div class="col-md-3"
					style="border: 1px #AAAAAA solid; margin-left: 70px;">
					<h3 class="title">
						<img id="playerPic3" src="player.png" class="play" /><span>即時熱門排行</span>
					</h3>
					<h6 style="margin: 0;">1<img src="left.JPG" style="margin-left:10px;" /></h6>
					<h4 style="margin: 0;">7:00 am - 1:30 pm</h4>
					<p>
