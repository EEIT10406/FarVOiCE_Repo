...
@WebFilter(
		...
		initParams = { 
				...
				@WebInitParam(name = "mustLogin3", value = "/personalPage/personalPage.jsp"),				
				@WebInitParam(name = "mustLogin3", value = "/personalPage/personalDetail.jsp"),				
				@WebInitParam(name = "mustLogin4", value = "/funding/startProject.jsp"),				
