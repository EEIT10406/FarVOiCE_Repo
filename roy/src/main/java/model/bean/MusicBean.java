...
public class MusicBean {
	...
	// 1228
	/*
	 * music_id int identity primary key, music_name varchar(30), member_username
	 * varchar(30) REFERENCES member (member_username), music_music varbinary(max) ,
	 * --實體檔案，上傳時需要限制大小及格式 music_caption varchar(200),--說明文字 music_uploadTime
	 * datetime, music_playCount int, music_styleName varchar(50), --接受多種風格
	 * music_lyric varchar(800), music_likeCount int, music_Image varbinary(max),
	 * --上傳時需要限制大小 music_ban bit, music_unavailable bit,--下架
	 */
//	@ManyToOne
