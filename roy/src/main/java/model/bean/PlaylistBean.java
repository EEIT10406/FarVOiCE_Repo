...
public class PlaylistBean {
	...
	public String toString() {
		return "PlaylistBean [playlist_id=" + playlist_id + ", member_username=" + member_username + ", playlist_name="
				...
				+ playlist_privacy + ",member_nickname=" + member_nickname + "]";
	}

	// 1228
	/*
	 * playlist_id int primary key, member_username varchar(30) REFERENCES member
	 * (member_username), playlist_name varchar(30) , playlist_image
	 * varbinary,--上傳時需要限制大小 playlist_registerTime datetime, playlist_musicCount
	 * int, playlist_privacy bit,
	 * 
	 */
