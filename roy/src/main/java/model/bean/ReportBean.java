...
public class ReportBean {
	...
	/*
	 * report_id int primary key, member_usernameReportS varchar(30) REFERENCES
	 * member (member_username), member_usernameReportM varchar(30) REFERENCES
	 * member (member_username), music_idReportM int REFERENCES Music (music_id),
