					...
					<div class="row tabs">
						<div class="col-sm-3">
							<ul class="nav nav-pills nav-stacked">
								...
								<li class="active"><a href="#emotion"> 抒情 </a></li>
						...
						<div class="col-sm-9">
							<div class="tab-content">
								...
								<div class="tab-pane fade in active" id="emotion">
									<div class="row">
										<div class="col-md-7">
											<div style="font-size: 25px; margin-bottom: 30px; margin-top: 20px; color: red;">抒情</div>
